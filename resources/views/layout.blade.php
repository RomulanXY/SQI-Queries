...
<html lang="en">
  <head>
    ...
    <title>Home - RomulanXY Blog</title>
    <!-- Css -->
  ...
  <body>
    <div id="wrapper">
      ...
      <div class="sidebar">
        ...
        <p class="brand-title"><a href="">RomulanXY Blog</a></p>
        ...
        <div class="side-links">
          <ul>
            ...
            @guest
              ...
              <li><a class="{{ Request::routeIs('register') ? 'active' : '' }}" href="{{ route('register') }}">Sign up</a></li>  
            @endguest
            @auth
        ...
        <footer class="sidebar-footer">
          ...
          <small>&copy 2022 RomulanXY Blog</small>
        </footer>
      </div>
      ...
      <footer class="main-footer">
        ...
        <small>&copy 2022 RomulanXY's Blog</small>
      </footer>
    </div>
